...
Can you solve this real interview question? Traffic Signal Color - You are given an integer timer representing the remaining time (in seconds) on a traffic signal.
